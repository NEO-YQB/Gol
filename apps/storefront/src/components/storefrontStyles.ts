export const storefrontStyles = {
  ...
  headerDropdownTrigger: 'inline-flex items-center gap-2 rounded-full px-4 py-2 text-sm font-bold transition-all duration-300 hover:translate-y-[-1px]',
  headerDropdownPanel:
  ...
  headerDropdownChildPanel:
    'invisible absolute right-[calc(100%+8px)] top-0 z-40 min-w-[240px] rounded-[22px] border border-[var(--header-glass-border)] bg-[var(--header-glass-bg)] p-3 opacity-0 shadow-[0_20px_45px_rgba(20,29,25,0.16)] backdrop-blur-2xl transition-all duration-200 group-hover/item:visible group-hover/item:opacity-100',
  headerAction:
