export const storefrontShared = {
  pageShell: 'min-h-screen bg-[#f5efe4] text-[#173126]',
  pageContainer: 'mx-auto max-w-[1440px] px-4 pb-20 md:px-8',
  ...
  editorialSection:
    'mb-8 overflow-hidden rounded-[34px] shadow-[0_18px_42px_rgba(38,24,9,0.08)] md:grid md:grid-cols-[minmax(0,360px)_minmax(0,1fr)]',
  ...
  emptyState: 'rounded-[34px] border border-dashed border-[#caa67f] bg-white/70 px-6 py-14 text-center shadow-[0_10px_30px_rgba(52,36,17,0.08)]',
  footer: 'px-2 pt-6 text-center text-sm text-[#7b6b58]',
}
