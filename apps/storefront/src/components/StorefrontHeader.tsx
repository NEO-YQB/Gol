        ...
        <div className="flex shrink-0 items-center gap-2 md:gap-3">
          ...
          <div className={storefrontStyles.headerDropdownRoot}>
            ...
            {openDesktopMenu === 'cart' ? (
              <div className={`${storefrontStyles.headerDropdownPanel} fixed left-4 right-4 top-[88px] w-auto max-w-none md:absolute md:left-0 md:right-auto md:top-[calc(100%+10px)] md:w-[min(92vw,380px)] md:max-w-[380px]`}>
