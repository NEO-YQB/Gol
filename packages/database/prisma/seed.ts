...
const defaultRolePermissions: Record<string, string[]> = {
  ADMIN: [
    ...
    'update:Cart',
    'delete:Cart',
    'create:PlatformPromotion',
    'read:PlatformPromotion',
    'update:PlatformPromotion',
    'delete:PlatformPromotion',
    'create:Coupon',
    'read:Coupon',
    'update:Coupon',
    'delete:Coupon',
    'create:PaymentGatewayConfig',
    'read:PaymentGatewayConfig',
    ...
    'read:WalletTransaction',
    'create:SupportTicket',
    'read:SupportTicket',
    'update:SupportTicket',
    'create:SupportTicketNote',
    'read:SupportTicketNote',
  ],
  VENDOR: [
    'read:Product',
    'read:Category',
    ...
    'update:Product',
    'delete:Product',
    'create:VendorDiscount',
    'read:VendorDiscount',
    'update:VendorDiscount',
    'delete:VendorDiscount',
    'create:File',
  ],
  CUSTOMER: [
    'read:Product',
