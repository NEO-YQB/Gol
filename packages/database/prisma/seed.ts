...
const permissionCatalog: PermissionSeed[] = [
  ...
  { action: 'read', subject: 'VendorOnboardingRequest', conditions: null },
  { action: 'review', subject: 'VendorOnboardingRequest', conditions: null },
...
const defaultRolePermissions: Record<string, string[]> = {
  ...
  SUPPORT_AGENT: [
    ...
    'read:VendorOnboardingRequest', 'review:VendorOnboardingRequest',
  ],
  ACCESS_MANAGER: [
    ...
    'read:AdminPermission', 'read:VendorOnboardingRequest', 'review:VendorOnboardingRequest',
  ],
};
...
async function seedCatalogAndStores(users: Awaited<ReturnType<typeof ensureUsers>>) {
  ...
  const productOne = await upsertProduct({
    ...
    mainImageAlt: 'دسته گل رز قرمز کلاسیک',
    images: [productImage] as unknown as Prisma.InputJsonValue,
    gallery: [{ url: productImage, alt: 'نمای اصلی دسته گل رز قرمز' }] as unknown as Prisma.InputJsonValue,
  ...
  const productTwo = await upsertProduct({
    ...
    discountPrice: null,
    mainImage: productImage,
    mainImageAlt: 'باکس گل سفید طلایی لوکس',
    images: [productImage] as unknown as Prisma.InputJsonValue,
    gallery: [{ url: productImage, alt: 'نمای باکس گل سفید طلایی' }] as unknown as Prisma.InputJsonValue,
    publicationStatus: 'PUBLISHED',
    isPurchasable: true,
    isArchived: false,
    storeId: storeOne.id,
  ...
  const productThree = await upsertProduct({
    ...
    mainImage: productImage,
    mainImageAlt: 'گیاه آپارتمانی فیکوس الاستیکا',
    images: [productImage] as unknown as Prisma.InputJsonValue,
    gallery: [{ url: productImage, alt: 'نمای گیاه فیکوس الاستیکا' }] as unknown as Prisma.InputJsonValue,
    publicationStatus: 'PUBLISHED',
    isPurchasable: true,
    isArchived: false,
    storeId: storeTwo.id,
  ...
  const productFour = await upsertProduct({
    ...
    discountPrice: null,
    mainImage: productImage,
    mainImageAlt: 'سانسوریا ابلق با گلدان تزئینی',
    images: [productImage] as unknown as Prisma.InputJsonValue,
    gallery: [{ url: productImage, alt: 'نمای سانسوریا ابلق' }] as unknown as Prisma.InputJsonValue,
    publicationStatus: 'PUBLISHED',
    isPurchasable: true,
    isArchived: false,
    storeId: storeTwo.id,
